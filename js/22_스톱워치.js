...
/* startBtn 클릭 시 
10ms 마다 count 1 증가 + 화면 시간 변경 */

startBtn.addEventListener("click",() => {

  // 이전에 start 버튼이 클릭 된 적이 있을 경우
  // -> 버튼에 작성 내용이 "PUASE"인 경우
  if(startBtn.innerText === "PAUSE"){
    clearInterval(currentInterval); // 이전 interval을 멈춤
...
/** 전달 받으 수가 10 미만인 경우 앞에 "0" 붙여서 반환 */ 
...
/* RECORD 버튼 클릭 시
   현재 출력 되는 시간을 얻어와
   li 태그로 만들어 #recordContainer의 첫번 째 자식으로 추가 */
