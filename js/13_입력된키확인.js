// 준비한 이미지 파일명 저장할 배열
const images=["말왕.jpg","뭉생충.jpg","빠더너스.jpg","침착맨.jpg"];
// 클래스가 btn인 요소를 모두 얻어와 배열 형태로 저장
...
// e.pageY : 세로방향 마우스 위치(윗쪽에서 떨어진 px)

cursorImage.style.left = `${e.pageX}px`;
cursorImage.style.top = `${e.pageY-25}px`;
})
