...
function check1() {
  ...
  // input1.vlaue : input1 요소에 입력된 값 (string)
...
function calc(op) {
  ...
  /* break : 현재 case까지만 해석하고 switch문를 멈춤 */
  //    -> break 미작성 시 현재 case 수행 후 멈추지 않고 break가 존재하는 case문 까지 계속 수행
  ...
  switch (op) {
    ...
    // 알맞은 case가 없ㅇ면 default 실행
    default: result = "잘못된 연산자";
  }
  // 아이디가 "calcResult"인 요소를 얻어와
  // 내용 (innterText) 으로 result 를 대입
