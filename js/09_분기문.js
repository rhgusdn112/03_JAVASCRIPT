...
function check2(){
  ...
  // -> true라고 작성하면 조건식이 false가 되는 경우가 없다.
  // -> 무한 반복
  ...
  while(true){
    ...
    const value = prompt("숫자 입력"); // 취소하면 null
...
function check4() {
  ...
  // 123456789를 5줄 출력하는 코드
  // 단, 1번 줄에서는 1 제외하기    23456789
  //     2번 줄에서는 2 제외하기    13456789
  //     3번 줄에서는 3 제외하기    12456789
  //     n번 줄에서는 n 제외하기    12356789
  //                                12346789 ...                                    
  ...
  function startGame(){
   ...
   while(true) { // 무한 반복
    ...
    if(isNaN(value)){ // 숫자가 아닌 값을 입력 한 경우
      alert("숫자만 입력해 주세요")
      continue;
    }
